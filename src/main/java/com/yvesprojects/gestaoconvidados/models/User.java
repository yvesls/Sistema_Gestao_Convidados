...
public class User {
	...
	@JsonProperty( access = Access.WRITE_ONLY ) // Define que a senha será somente para escrita, não retornando valor ao
												// registrar
	...
	public Set<ProfileEnum> getProfiles() {
		return this.profiles.stream().map( x -> ProfileEnum.toEnum( x ) ).collect( Collectors.toSet() ); // pega o perfil, transforma em stream, percorre, passa o valor do code e
																											// transforma em um setCollector
	}
