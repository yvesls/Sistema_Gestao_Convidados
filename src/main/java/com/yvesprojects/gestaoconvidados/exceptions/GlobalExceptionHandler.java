...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
   ...
   @ExceptionHandler(DataIntegrityViolationException.class)
    @ResponseStatus(HttpStatus.CONFLICT) // status 409 (cliente tentou criar um username já existente
    ...
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY) // status 422 usuário passou senha vazia ou inválida
